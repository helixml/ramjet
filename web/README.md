...
| `RJ_MACHINEVIEW_UPSTREAM_GPUS` | unset | dense semicolon-separated GPU sets matching `RJ_UPSTREAM`, for example `0,1,2,3;4,5`; the UI derives each engine's TP size from its set |
