...
operator confirmed the repair. The intake-air guard, bounded workload runtime,
common deployment lock, exact Compose/render authority, and rollback controls
below remain mandatory for every mutation and request-generating gate.
