...
The 2026-08-14 node06 cooling/AC moratorium was retired on 2026-08-25. The
procedure below still requires its candidate isolation, intake-air watchdog,
common deployment lock, bounded workload, and exact rollback authority; the
retirement is not permission to skip any of those controls.
